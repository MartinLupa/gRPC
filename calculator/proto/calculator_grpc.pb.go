...
type CalculatorServiceClient interface {
	Sum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*NumResponse, error)
	Primes(ctx context.Context, in *NumRequest, opts ...grpc.CallOption) (CalculatorService_PrimesClient, error)
...
func (c *calculatorServiceClient) Sum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*NumResponse, error) {
	out := new(NumResponse)
...
func (c *calculatorServiceClient) Primes(ctx context.Context, in *NumRequest, opts ...grpc.CallOption) (CalculatorService_PrimesClient, error) {
...
func (x *calculatorServicePrimesClient) Recv() (*NumResponse, error) {
	m := new(NumResponse)
...
func (x *calculatorServiceAvgClient) Send(m *NumRequest) error {
...
func (x *calculatorServiceMaxClient) Send(m *NumRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceMaxClient) Recv() (*NumResponse, error) {
	m := new(NumResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CalculatorServiceServer interface {
	Sum(context.Context, *SumRequest) (*NumResponse, error)
	Primes(*NumRequest, CalculatorService_PrimesServer) error
...
func (UnimplementedCalculatorServiceServer) Sum(context.Context, *SumRequest) (*NumResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sum not implemented")
}
func (UnimplementedCalculatorServiceServer) Primes(*NumRequest, CalculatorService_PrimesServer) error {
...
func (x *calculatorServicePrimesServer) Send(m *NumResponse) error {
...
func (x *calculatorServiceAvgServer) Recv() (*NumRequest, error) {
	m := new(NumRequest)
...
func (x *calculatorServiceMaxServer) Send(m *NumResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceMaxServer) Recv() (*NumRequest, error) {
	m := new(NumRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
